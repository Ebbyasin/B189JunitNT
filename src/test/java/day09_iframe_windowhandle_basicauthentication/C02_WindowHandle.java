...
public class C02_WindowHandle extends TestBase {
    ...
    public void test01() {
        ...
        driver.switchTo().newWindow(WindowType.WINDOW);// yeni pencerede acarak gecis yaptik
        driver.get("https://www.youtube.com");
        String youtbeWindowHandle=driver.getWindowHandle();
        ...
        driver.switchTo().window(youtbeWindowHandle);
        waitForSecond(2);
    ...
    public void test02() {
        ...
        //Window 2'de (yeni bir pencerede) https://www.youtube.com sayfasını açınız:
        driver.switchTo().newWindow(WindowType.TAB);// yeni SEKMEDE acarak gecis yaptik
        driver.get("https://www.youtube.com");
        String youtbeWindowHandle=driver.getWindowHandle();
